...
- Name: tests\smoke\auth-smoke.spec.ts >> Smoke — Login all 4 roles >> constructor login redirige a dashboard de constructor
- Location: tests\smoke\auth-smoke.spec.ts:29:3
