...
- Name: tests\smoke\auth-smoke.spec.ts >> Smoke — Login all 4 roles >> proveedor login redirige a dashboard de proveedor
- Location: tests\smoke\auth-smoke.spec.ts:40:3
